...
Write-Host "DevHQ orphan-process test is ready." -ForegroundColor Cyan
...
Write-Host "Keeping this parent attached so DevHQ can snapshot the complete process tree..."
